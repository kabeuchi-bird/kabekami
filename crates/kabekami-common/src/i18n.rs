...
pub static KANSAI: UiStrings = UiStrings {
    ...
    blacklist_current:  "この壁紙、二度と見せんといてや",
    copy_to_favorites:  "今の壁紙、お気に入りに入れたるで",
    quit:               "さいなら",
...
pub static OHOGOE: UiStrings = UiStrings {
    ...
    delete_current:     "もっと奥突いてっ♡♡♡おチンポで殴り潰してくださいぃぃ♡♡♡",
    blacklist_current:  "もう二度と会えない運命なんてっ♡♡♡でも忘れられないっ♡♡♡",
    copy_to_favorites:  "オナホになることを誓いますぅ♡♡♡一生オナホ扱いで構わないので中出ししてくださいぃ♡♡♡",
    ...
    fetch_now:          "おチンポ欲しさに尻尾振る媚び媚びオナホメスに躾けてくださぃっ♡♡♡",
    images:             "発",
};
